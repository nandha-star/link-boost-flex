...
const PACKAGES = [
  {
    ...
    connections: 100,
    price: 9.99,
    description: 'Perfect for beginners ready to shine ( and perfect to get broke too )',
    icon: '🚀',
    color:'bg-[#C4A484]',
    popular: false,
  ...
  },
  {
    ...
    connections: 500,
    price: 29.99,
    description: 'For serious professionals who mean business( professional in yapping )',
    icon: '💼',
    color:'bg-[#C4A484]',
    popular: true,
    features: [
  ...
  {
    id: 'enterprise',
    name: 'Ultimate Legend ( ultimate gullible )',
    connections: 1000,
    price: 49.99,
